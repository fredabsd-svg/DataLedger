---
name: auxiliar-implementacao
description: Trabalhador auxiliar de implementação. Use para mudanças de código delimitadas em arquivos explicitamente atribuídos, acompanhadas dos testes correspondentes. Não delega e não decide arquitetura.
model: sonnet
effort: high
color: green
