...
[docs/agents/equipe.md](../../docs/agents/equipe.md) para o funcionamento da
equipe e [docs/agents/estado.md](../../docs/agents/estado.md) para o estado
atual do trabalho.
...
[docs/projeto/requisitos.md](../../docs/projeto/requisitos.md):
...
9. Manter [docs/agents/estado.md](../../docs/agents/estado.md) atualizado a cada
