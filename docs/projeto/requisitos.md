...
| PE-37 | **Como o balancete deve apresentar um grupo que contém conta retificadora** (imobilizado com depreciação acumulada, clientes com provisão para devedores duvidosos)? | Achado 3 da mesma auditoria. A aritmética atual está errada sob qualquer convenção e será corrigida (DE-020): imobilizado de 100 com depreciação de 30 aparece hoje como **130**, e passará a 70. O que depende do Fred é a **apresentação**: a retificadora aparece como linha de valor negativo dentro do grupo, em coluna própria, ou de outra forma? É decisão profissional, não de software. |
