...
Atualizado em **2026-09-17**, a partir da `main` em **`6a10ead`** (PR #28
integrado — DL-024). Branch de trabalho
`docs/ordens-diretas-do-responsavel`, com a DL-025 em validação.
...
| [DL-025](../planos/DL-025-ordens-diretas-do-responsavel.md) | Reconhecer ordens diretas de Fred como demanda formal e autorização para executar o escopo pedido | **Em validação** na branch `docs/ordens-diretas-do-responsavel`; alteração documental, sem código de produto ou migração |
