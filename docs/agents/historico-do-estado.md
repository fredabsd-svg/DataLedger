# Histórico do estado do projeto (até 25/09/2026)

> **Este arquivo é HISTÓRICO, não estado.** Até 25/09/2026 este era o conteúdo
> integral de [`estado.md`](estado.md), que acumulou 3.457 linhas misturando o
> estado atual com o relato de cada rodada de auditoria. Foi movido para cá sem
> edição, para preservar o registro, e o `estado.md` foi reescrito enxuto.
> **Nada aqui descreve o estado atual** — afirmações como "em validação",
> "próximo passo" ou "`main` em ..." valiam na data em que foram escritas.
> O estado atual está em [`estado.md`](estado.md), e só lá.
